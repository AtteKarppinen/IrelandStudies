...
def initialization():
    min_int = 100
    max_int = 200
    # SystemRandom is a class that uses the os.urandom() function for generating random numbers 
    # from sources provided by the operating system. Suitable for cryptographic reasons
